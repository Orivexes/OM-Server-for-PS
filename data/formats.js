exports.BattleFormats = {
	...
	// formats
	// Relados:  Alright, let me explain a little of what I did here
	// Though it says "ou" and some of the other standard tiers, and the dropdown says so as well
	// The tiers still behave as they should under the pseudonym.  For example
	// searching OU battles is actually searching Clear Skies, and searching ubers is six move ou.
	// The rules are all in their, though.  You can't enter a weather OU team into the one marked OU,
	// because it has clear skies rules.
	...
	ou: {
		...
		banlist: ['Uber', 'Drizzle', 'Drought', 'Sand Stream', 'Snow Warning']
	},
	ubers: {
		effectType: 'Format',
		name: "Six Move OU",
		...
		searchShow: true,
		isTeambuilderFormat: true,
		ruleset: ['sixmove', 'Standard', 'Team Preview'],
